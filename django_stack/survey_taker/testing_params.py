...
#I set key directly as a string here. REALLY bad practice, but for a proof of concept (and with a monthly cap of 10 USD) it is fine. Setting the repos to private tho
#OPENAI_API_KEY = 
