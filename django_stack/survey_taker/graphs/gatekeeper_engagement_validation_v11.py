...
def moderate_with_retry(
    ...
    Args:
        generation_func: Function that generates content, returns AIMessage or similar
    ...
    for attempt in range(max_retries):
        # Generate content
        generated_content = generation_func()
        ...
        moderation_result = moderator_model.invoke(moderation_messages)
...
def standard_question_llm(state: dict):
    ...
    # Initialize prompter moderator model
    ...
    # Prepare generation function for moderation with prompt update capability
    ...
    # Generate and moderate question
    ...
    return {
        "messages": [
            AIMessage(content=question_response.content)
        ],
...
def transition_llm(state: dict):
    ...
    # Combine transition and initial question
